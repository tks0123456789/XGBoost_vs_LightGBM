...
def experiment_binary_gb(X_train, y_train, X_valid, y_valid,
    ...
    for params_xgb,  model_str in zip(params_xgb_lst, model_str_lst):
        ...
        dmp = bst.get_dump()
        leaf_cnts_dict[model_str] = [tree.count('leaf') for tree in dmp]
        
    # LightGBM
    metric = params_lgb['metric']
